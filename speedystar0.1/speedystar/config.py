...
__releaseError__ = 'Error: invalid Gaia data release. Options are DR2, EDR3, DR3, DR4, DR5. See speedystar.config.set_Gaia_release() docstring'
...
def set_Gaia_release(self,Gaia_release):
    ...
    if Gaia_release not in _Gaia_releases:
        raise ValueError(__releaseError__)
