...
class BayesianKDEClassifier:
    ...
    def __init__(self, X_class, Y_class, X_not_class, Y_not_class, threshold=0.5, bandwidth=1.0, p_class=1e5, weights = None):
        ...
        X_not_class = self.X_not_class
        Y_not_class = self.Y_not_class
        ...
        self.kde_class = KernelDensity(kernel='gaussian', bandwidth=self.base_bandwidth).fit(XY_class, sample_weight=self.weights)
...
if __name__ == '__main__':
    ...
    speedystar_cat = Table.read('/Users/mncavieres/Documents/2024-2/HVS/Data/speedystar_catalogs/speedy_flat.fits')
    ...
    bayesian_kde = BayesianKDEClassifier( X_class, Y_class, X_not_class, Y_not_class, bandwidth='scott', p_class=1e5, weights = None)
