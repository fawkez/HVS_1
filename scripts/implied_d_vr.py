...
def post_process_results(plx, eplx, VGCR, VR):
    """
    ...
    plx_mas = (plx.value * u.m**-1).to(1/u.pc, equivalencies=u.parallax())
    eplx_mas = (eplx.value * u.m**-1).to(1/u.pc, equivalencies=u.parallax())
